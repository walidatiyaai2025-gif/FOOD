...
<head>
    ...
    <style>:root{font-family:Inter,system-ui,sans-serif;color:#0f172a;background:#f8fafc}body{margin:0;min-height:100vh;display:grid;place-items:center;padding:24px}.card{max-width:620px;background:#fff;border:1px solid #e2e8f0;border-radius:22px;padding:34px;box-shadow:0 20px 55px rgba(15,23,42,.08)}.code{font-weight:900;color:#64748b;letter-spacing:.12em}h1{margin:10px 0}.muted{color:#64748b;line-height:1.7}a{display:inline-block;margin-top:16px;padding:10px 14px;border-radius:11px;background:#0f172a;color:#fff;text-decoration:none}</style>
</head>
