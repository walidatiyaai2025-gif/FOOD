...
<head>
    ...
    <style>
        ...
        .kpi-value{max-width:100%;font-family:var(--foodex-font-en);font-size:clamp(1.45rem,2vw,1.75rem);font-weight:var(--foodex-font-weight-bold);line-height:1.1;margin:13px 0 9px;white-space:normal}
