...
<head>
    ...
    <style>
        *{box-sizing:border-box}body{margin:0;font-family:var(--foodex-font-ui);background:var(--foodex-background);color:var(--foodex-ink)}
        a{color:inherit;text-decoration:none}.dashboard-layout{display:grid;direction:ltr;grid-template-columns:minmax(0,1fr) var(--foodex-sidebar-width);min-height:100vh}.dashboard-shell{min-width:0}.dashboard-sidebar{grid-column:2;background:var(--foodex-surface);border-inline-start:1px solid var(--foodex-border);min-height:100vh}html[dir=rtl] .dashboard-shell,html[dir=rtl] .dashboard-sidebar{direction:rtl}
        html[dir=ltr] .dashboard-layout{grid-template-columns:var(--foodex-sidebar-width) minmax(0,1fr)}html[dir=ltr] .dashboard-sidebar{grid-column:1;grid-row:1}html[dir=ltr] .dashboard-shell{grid-column:2;grid-row:1}
        .topbar{height:var(--foodex-header-height);background:#fff;border-bottom:1px solid var(--foodex-border);display:grid;direction:ltr;grid-template-columns:minmax(210px,1fr) minmax(150px,.45fr) minmax(320px,520px);grid-template-areas:"profile actions search";align-items:center;gap:18px;padding:0 24px;position:sticky;top:0;z-index:10}
        html[dir=ltr] .topbar{grid-template-columns:minmax(230px,1fr) minmax(320px,520px) minmax(210px,1fr);grid-template-areas:"profile search actions"}
        .profile{grid-area:profile;display:flex;align-items:center;gap:10px;direction:ltr}.avatar{width:40px;height:40px;border-radius:50%;display:grid;place-items:center;background:var(--foodex-green-soft);color:var(--foodex-green-dark);font-weight:900;border:1px solid #d5eddd}.profile small{display:block;color:var(--foodex-muted)}
        .top-actions{grid-area:actions;display:flex;align-items:center;justify-content:center;gap:16px;color:#475467}html[dir=ltr] .top-actions{justify-content:flex-end}html[dir=rtl] .top-actions{direction:rtl}html[dir=rtl] .profile>div:last-child{direction:rtl;text-align:right}.language,.bell{display:inline-flex;align-items:center;gap:7px}.bell{position:relative;font-size:20px}.bell b{position:absolute;width:9px;height:9px;border-radius:50%;background:var(--foodex-orange);inset:-1px -2px auto auto}
        .global-search{grid-area:search;position:relative}html[dir=rtl] .global-search{direction:rtl}.global-search input{width:100%;height:44px;border:1px solid var(--foodex-border);border-radius:10px;padding:0 42px 0 15px;background:#fff;outline:none}.global-search input:focus{border-color:var(--foodex-green);box-shadow:0 0 0 3px rgba(21,138,58,.1)}.search-icon{position:absolute;inset-inline-end:14px;top:12px;color:#667085}
        ...
        .kpis{display:grid;direction:ltr;grid-template-columns:repeat(4,minmax(0,1fr));gap:14px}.kpi{background:#fff;border:1px solid var(--foodex-border);border-radius:var(--foodex-radius-card);padding:17px;min-height:142px;box-shadow:var(--foodex-shadow-sm)}html[dir=rtl] .kpi{direction:rtl}.kpi-head{display:flex;direction:ltr;align-items:center;gap:12px}html[dir=rtl] .kpi-label{direction:rtl;text-align:right}.kpi-icon{width:44px;height:44px;border-radius:50%;display:grid;place-items:center;font-size:21px}.green{background:var(--foodex-green-soft);color:var(--foodex-green)}.orange{background:var(--foodex-orange-soft);color:var(--foodex-orange)}.blue{background:#edf4ff;color:var(--foodex-blue)}.kpi-label{font-weight:750}.kpi-label small{display:block;font-weight:500;color:var(--foodex-muted);margin-top:2px}.kpi-value{font-size:28px;font-weight:850;margin:13px 0 7px}.delta{font-size:12px;color:var(--foodex-green);background:var(--foodex-green-soft);border-radius:999px;padding:4px 8px;display:inline-flex}.delta.down{color:var(--foodex-red);background:#fff0f0}.delta.na{color:var(--foodex-muted);background:#f2f4f7}
        .middle{display:grid;direction:ltr;grid-template-columns:minmax(0,2fr) minmax(300px,1fr);gap:14px;margin-top:14px}html[dir=rtl] .middle>.panel{direction:rtl}.panel{background:#fff;border:1px solid var(--foodex-border);border-radius:15px;padding:18px;box-shadow:0 7px 20px rgba(16,24,40,.035)}.panel-title{display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:12px}.panel-title h2{font-size:17px;margin:0}.panel-title small{display:block;color:var(--foodex-muted);font-weight:500;margin-top:2px}.legend{display:flex;gap:14px;color:var(--foodex-muted);font-size:12px}.dot{width:9px;height:9px;border-radius:50%;display:inline-block;margin-inline-end:4px}.chart{height:245px;width:100%;overflow:hidden}.chart svg{width:100%;height:100%}.chart-grid{stroke:#edf0f4;stroke-width:1}.orders-bar{fill:var(--foodex-orange-bright)}.revenue-line{fill:none;stroke:var(--foodex-green);stroke-width:3;stroke-linecap:round;stroke-linejoin:round}.revenue-dot{fill:#fff;stroke:var(--foodex-green);stroke-width:3}.axis-label{font-size:10px;fill:#98a2b3}
