...
final class PushDeviceController extends Controller
{
    public function store(Request $request): JsonResponse
    {
        ...
        $device = PushDeviceToken::query()->updateOrCreate(['token_hash' => $hash], ['user_id' => $user->id, 'app' => $data['app'], 'platform' => $data['platform'], 'environment' => $data['environment'], 'token_encrypted' => $data['token'], 'revoked_at' => null]);
