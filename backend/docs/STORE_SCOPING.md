...
- Public B2C browsing is a separate product flow and must not reuse authenticated admin scope as a substitute for catalog visibility rules.

## Covered store-owned models

Direct scope: warehouses, store products, carts, orders, promotions, banners and settings.
