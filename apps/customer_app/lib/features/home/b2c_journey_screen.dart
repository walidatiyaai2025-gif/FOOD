  ...
  (String, String, List<Widget>) _contentFor(BuildContext context, String pattern) {
    switch (pattern) {
      ...
      case CustomerRoutePaths.entry:
        return (context.tr('customer.entry.title'), context.tr('customer.entry.subtitle'), [_button(context.tr('customer.action.guest')), _button(context.tr('customer.action.login'))]);
      ...
      case CustomerRoutePaths.productDetails:
        return (context.tr('customer.product.title'), context.tr('customer.product.subtitle'), [_button(context.tr('customer.action.add_cart'))]);
      case CustomerRoutePaths.cart:
        return (context.tr('customer.cart.title'), context.tr('customer.cart.subtitle'), [_empty(context.tr('customer.cart.empty')), _button(context.tr('customer.action.checkout'))]);
      case CustomerRoutePaths.checkoutAuth:
        return (context.tr('customer.checkout_login.title'), context.tr('customer.checkout_login.subtitle'), [_button(context.tr('customer.action.login'))]);
      case CustomerRoutePaths.checkoutAddressPayment:
        return (context.tr('customer.checkout.title'), context.tr('customer.checkout.subtitle'), [_section(context.tr('customer.checkout.address')), _section(context.tr('customer.checkout.payment')), _button(context.tr('customer.action.confirm_order'))]);
